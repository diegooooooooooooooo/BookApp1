...
public data class LibroDetalleFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): LibroDetalleFragmentArgs {
      bundle.setClassLoader(LibroDetalleFragmentArgs::class.java.classLoader)
      val __libroId : Int
      ...
      return LibroDetalleFragmentArgs(__libroId)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): LibroDetalleFragmentArgs {
      val __libroId : Int?
