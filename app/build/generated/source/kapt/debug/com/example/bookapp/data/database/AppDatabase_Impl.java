  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(8) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS `libros` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `titulo` TEXT NOT NULL, `autor` TEXT NOT NULL, `isbn` TEXT NOT NULL, `categoria` TEXT NOT NULL, `editorial` TEXT NOT NULL, `ejemplares` INTEGER NOT NULL, `valor` REAL NOT NULL, `estado` TEXT NOT NULL, `portadaUrl` TEXT, `isPlaceholder` INTEGER NOT NULL)");
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS `socios` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `nombre` TEXT NOT NULL, `dni` TEXT NOT NULL, `telefono` TEXT NOT NULL, `correo` TEXT)");
        db.execSQL("CREATE UNIQUE INDEX IF NOT EXISTS `index_socios_correo` ON `socios` (`correo`)");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '7d24c560b28edee9cf22b7308af52c42')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        final HashMap<String, TableInfo.Column> _columnsLibros = new HashMap<String, TableInfo.Column>(11);
        ...
        _columnsLibros.put("portadaUrl", new TableInfo.Column("portadaUrl", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsLibros.put("isPlaceholder", new TableInfo.Column("isPlaceholder", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsSocios.put("correo", new TableInfo.Column("correo", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
    ...
    }, "7d24c560b28edee9cf22b7308af52c42", "d4788ae46ccf1bc9fc55916f2320dc8f");
