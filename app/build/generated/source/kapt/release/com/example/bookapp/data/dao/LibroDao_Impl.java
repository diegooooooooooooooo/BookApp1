...
public final class LibroDao_Impl implements LibroDao {
  ...
  public LibroDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfLibroEntity = new EntityInsertionAdapter<LibroEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `libros` (`id`,`titulo`,`autor`,`isbn`,`categoria`,`editorial`,`ejemplares`,`valor`,`estado`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?)";
      }
    ...
    this.__updateAdapterOfLibroEntity = new EntityDeletionOrUpdateAdapter<LibroEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `libros` SET `id` = ?,`titulo` = ?,`autor` = ?,`isbn` = ?,`categoria` = ?,`editorial` = ?,`ejemplares` = ?,`valor` = ?,`estado` = ? WHERE `id` = ?";
      }
  ...
  @Override
  public Object insert(final LibroEntity libro, final Continuation<? super Long> $completion) {
  ...
  @Override
  public Object delete(final LibroEntity libro, final Continuation<? super Unit> $completion) {
  ...
  @Override
  public Object update(final LibroEntity libro, final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
      ...
      public List<LibroEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new LibroEntity(_tmpId,_tmpTitulo,_tmpAutor,_tmpIsbn,_tmpCategoria,_tmpEditorial,_tmpEjemplares,_tmpValor,_tmpEstado);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Object getLibroById(final int id, final Continuation<? super LibroEntity> $completion) {
      ...
      public LibroEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _tmpEstado = __converters.toLibroEstado(_tmp);
            _result = new LibroEntity(_tmpId,_tmpTitulo,_tmpAutor,_tmpIsbn,_tmpCategoria,_tmpEditorial,_tmpEjemplares,_tmpValor,_tmpEstado);
          } else {
            _result = null;
          }
          return _result;
