...
public abstract interface SocioDao {
    ...
    @androidx.room.Query(value = "SELECT * FROM socios WHERE LOWER(correo) = LOWER(:correo) LIMIT 1")
    @org.jetbrains.annotations.Nullable()
